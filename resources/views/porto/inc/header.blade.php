            ...
            <div class="col-xxl-5">
                ...
                <div class="text-center text-xxl-start">
                    ...
                    <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                        <div class="text-uppercase">{{ $profile->jurusan }}</div>
                    </div>
                    <div class="fs-3 fw-light text-muted">{{ $profile->deskripsi }}</div>
                    <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">{{ $profile->nama }}</span>
                    </h1>
                    <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                        <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="{{ route('porto.resume') }}">Resume</a>
                        <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder"
                            href="{{ route('porto.project') }}">Projects</a>
                    </div>
                </div>
            </div>
            <div class="col-xxl-7">
                ...
                <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                    <div class="profile bg-gradient-primary-to-secondary">
                        ...
                        <img class="profile-img" src="{{ asset('storage/image/' . $profile->foto) }}" alt="..." />
        ...
        <div class="row gx-5 justify-content-center">
            <div class="col-xxl-8">
                <div class="text-center my-5">
                    <h2 class="display-5 fw-bolder"><span class="text-gradient d-inline">Tentangku</span></h2>
                    <p class="lead fw-light mb-4">Fatsyah Regiyanto | IT Ethusiast {{ $profile->jurusan }}</p>
                    <p class="text-muted">{{ $profile->deskripsi }} Hallo! Saya Fatsyah Regiyanto, lulusan SMKN 5 Jakarta jurusan Teknik Pemesinan, dengan pengalaman sebagai operator produksi di industri otomotif. Saya memiliki minat besar pada teknologi dan otomotif. Setelah bekerja, saya melanjutkan pendidikan di Sekolah Tinggi Ilmu Komputer Cipta Karya Informatika, mengambil jurusan Teknik Informatika untuk mendalami bidang yang saya senangi.</p>
