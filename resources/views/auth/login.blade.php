    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="../../index2.html" class="h1"><b>CRUD</b>porto</a>
            </div>
            <div class="card-body">
                <p class="login-box-msg">admin@gmail.com (12345678) </p>
                ...
                <form action="{{ route('action-login') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input required name="password" type="password" name="password" class="form-control" placeholder="Password">
                        <div class="input-group-append">
                            <div class="input-group-text">
